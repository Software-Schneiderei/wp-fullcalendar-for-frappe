 ...
 */
function software_schneiderei_fullcalendar_for_frappe_block_init() {
	/**
...
add_action( 'init', 'software_schneiderei_fullcalendar_for_frappe_block_init' );
